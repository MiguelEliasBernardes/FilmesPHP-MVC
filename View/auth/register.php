        ...
        <section class="flex items-center w-1/2 flex-col pt-26 gap-15">
            ...
            <form action="" class="w-4/8 flex flex-col gap-8">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="border-2 border-(--gray-300) rounded-lg  flex items-center gap-5 py-2 pl-3"> <img src="../../public/assets/icon/User-Regular.svg" alt="img" class="w-6 h-6" /></> <input type="text" class="w-3/4 focus:outline-none text-(--gray-600) opacity-100 font-(family-name:--nunito)" placeholder="Nome"></li>
