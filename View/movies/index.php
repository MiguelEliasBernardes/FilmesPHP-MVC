...
<body class="bg-(--gray-100)">
    ...
    <header class="flex justify-between text-(--gray-500) px-4 pt-2 items-center">
        <img src="../../public/assets/Vector/Logo.svg" alt="Logo" class="w-14 mr-20">

        <nav>
            <ul  class="flex gap-6 font-(family-name:--nunito) font-light">
                <li class="flex items-center bg-(--gray-300) text-(--purple-light) rounded py-2 px-3"><svg width="20" height="20" class="mr-1" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
