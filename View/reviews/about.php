...
<body class="bg-(--gray-100) min-h-screen">
    ...
    <main class="flex items-center flex-col">
        ...
        <section class=" w-3/4 h-screen max-h-[650px] flex items-center gap-10 text-(--gray-600) font-(family-name:--nunito) ">
            <img src="<?= $movie['image'] ?>" alt="movie picture" class="h-4/5 max-w-2/5 rounded-lg shadow-[0px_0px_9px_0px_#892CCD]">

            <div class="h-4/5 flex flex-col gap-5">
                <a href="index.php?route=explore" class="flex gap-2 items-center">
                ...
                <div class="flex space-y-2 items-center w-full">
                    <?php
                ...
                <p class="mt-10 text-lg break-words w-96 overflow-hidden">
                    <?= $movie['description'] ?>
                </p>
            </div>
        </section>
        ...
        <section class="w-3/4">
            <div class="flex justify-between items-center">
                <h2 class="text-(--gray-700) font-(family-name:--rajd) text-2xl font-bold">Avaliações</h2>

                <button onclick="openModal()" class="text-white bg-(--purple-base) font-(family-name:--nunito) flex items-center gap-3 px-6 py-4 rounded-lg">
                    <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script src="js/reviewCreate.js"></script>
</body>
</html>